//! Per-line CCITT-T.6 decoder. Direct port of `python-reference/vigb_max2pdf.py:_decomp_line`.
...
///
/// Mirrors `python-reference/vigb_max2pdf.py:_table_to_row` (line 332). `row_bytes` is the
...
/// (1 = black). Mirrors `python-reference/vigb_max2pdf.py:_table_from_raw` (line 360).
...
///
/// Mirrors `python-reference/vigb_max2pdf.py:_resync_probe` (line 383). Used only by
