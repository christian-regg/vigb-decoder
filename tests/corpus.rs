...
//! `max2pdf.py`. Used to catch decoder regressions against the user's
//! private archive without committing personal documents to git.
//!
...
//!
//! ```powershell
//! python "<path>\max2pdf.py" "$env:VIGB_DECODER_CORPUS\*.max" -o "$env:VIGB_DECODER_REFERENCE"
//! ```
//!
